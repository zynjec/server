...
zones[xi.zone.ALTAIEU] =
{
    text =
    {
        ...
        AMULET_SHATTERED              = 7508, -- The <item> held by <name> has shattered...
        LIGHT_STOLEN                  = 7509, -- The <item> was stolen by Nag'molada...
        OBTAIN_BUT_STOLEN             = 7510, -- You obtain the <item>, only to have it stolen by Nag'molada...
